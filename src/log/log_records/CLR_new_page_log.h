...
class CLRNewPageLog : public LogRecord {
 public:
  CLRNewPageLog(lsn_t lsn, xid_t xid, lsn_t prev_lsn, oid_t oid, pageid_t prev_page_id, pageid_t page_id);

  size_t SerializeTo(char *data) const override;
  static std::shared_ptr<CLRNewPageLog> DeserializeFrom(lsn_t lsn, const char *data);
