...
module btb (
    ...
    btb_table table_0(
        ...
        .rst(rst),
        .pc_now(pc),
        .pc_branch_now(pc_branch),
        .state_bit(state_bit_table[0]),
        .we(we_table[0]),
        .pc_next(pc_next_table[0]),
        .branch_or_4(branch_or_4_table[0]),
        .pc_read(pc_read)
